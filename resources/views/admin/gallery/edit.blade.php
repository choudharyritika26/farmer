...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1 style="margin-top: 20px">Edit Gallery</h1>
            {{-- <button class="btn btn-dark" href="{{ route('gallery-index') }}">Submit</button> --}}
            <span>
                <h1 style="margin-left: 95%; margin-top: -30px"><a href="{{ route('gallery-index') }}">Back</a></h1>
            </span>
            {{-- <nav>
        <ol class="breadcrumb">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('update-gallery',$gallery->id) }}" method="post"
                                ...
                                <div class="col-12">
                                    ...
                                    <img src="{{ asset('storage/' . $gallery->image) }}" alt="" class="img-fluid mb-3"
                                        style="width: 200px;height:150px;">
                                    <input type="file" class="form-control" name="image" value="{{ $gallery->image }}"
                                        id="image">
                                </div>

                                <div class="card-action submitEditGalleryBtn">
                                    <button class="btn btn-success" href="{{ route('gallery-index') }}">Submit</button>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            // Handle the form submission for the gallery
            $('.submitEditGalleryBtn').click(function(e) {
                //alert('jijed');
                e.preventDefault();
                ...
                $.ajax({
                    type: 'POST',
                    // Adjust the route for the gallery form submission
                    url: '{{ route('update-gallery', $gallery->id) }}',
                    data: formData,
