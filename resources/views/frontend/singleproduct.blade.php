...
@section('content')
    ...
    <section class="ftco-section ftco-degree-bg">
        <div class="container">
            <div class="row no-gutters slider-text align-items-end justify-content-center">
                <div class="col-md-9 ftco-animate pb-5 text-center">
                    <h1 class="mb-3 bread" style="color:#4e9525 ">Product Single</h1>
            ...
            <div class="row">
                <div class="col-lg-12 ftco-animate">
                    ...
                    <div class="about-author d-flex p-4 bg-lights">
                        <div class="bio mr-5">
                            <img src="{{ 'frontend/images/image_1.jpg' }}" alt="Image placeholder" class="img-fluid mb-4">
                        </div>
                        <div class="desc">
...
<br>
                    <div class="about-author d-flex p-4 bg-lights">
                        <div class="bio mr-5">
                            <img src="{{ 'frontend/images/image_2.jpg' }}" alt="Image placeholder" class="img-fluid mb-4">
                        </div>
                        <div class="desc">
                            <h2>George Washington</h2>
                            <p>Quisquam esse aliquam fuga distinctio, quidem delectus veritatis reiciendis. Nihil explicabo quod,
