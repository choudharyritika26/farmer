...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1 style="margin-top: 20px">Add Management</h1>
            <span>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            ...
                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('store-management') }}" method="post"
                                ...
                                <div class="col-12 p-3">
                                    ...
                                    <select name="aboutuslist" id="aboutuslist" class="form-control">
                                        <option value="">Select About Us List</option>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.submitmanagementBtn').click(function(e) {
                //alert('jijed');
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    url: '{{ route('store-management', isset($management) ? $management->id : null) }}',
                    data: formData,
