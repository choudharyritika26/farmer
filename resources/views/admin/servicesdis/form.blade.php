...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="margin-top: 20px">Add Services Discription</h1>
      <span><h1 style="margin-top:-30px; margin-left:95%;"><a href="{{route('servicesdis-index')}}">Back</a></h1></span>
      {{-- <nav>
        <ol class="breadcrumb">
      ...
      @endif
          <div class="card p-3">
            <div class="card-body p-3">
              ...
              <!-- Vertical Form -->
              <form class="row g-3" action="{{route('store-servicesdis')}}" method="post" enctype="multipart/form-data">
                @csrf
                {{-- <div class="col-12">
                ...
                <div class="card-action">
                  <button class="btn btn-success submitEditservicesdisBtn"
                     >Submit</button>
                  {{-- <button class="btn btn-danger"  href="{{route('servicesdis-index')}}">Cancel</button> --}}
              </div>
              </form><!-- Vertical Form -->
