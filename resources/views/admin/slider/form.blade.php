...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <span><h1 style="margin-left: 95%; margin-top: -30px"><a href="{{route('slider-index')}}">Back</a></h1></span>
      {{-- <nav>
        <ol class="breadcrumb">
            ...
            <div class="card-body">
              ...
              <form class="row g-3" action="{{route('store-slider')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-action">
                  <button class="btn btn-success submitSliderBtn"
                      href="{{route('slider-index')}}">Submit</button>
                  {{-- <button class="btn btn-danger"  href="{{route('slider-index')}}">Cancel</button> --}}
              </div>
              </form><!-- Vertical Form -->
