...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1 style="margin-top: 20px">Add Our Product List</h1>
            <span>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            ...
                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('store-ourproductlist') }}" method="post"
                                ...
                                <div class="card-action">
                                    <button class="btn btn-success submitourproductlistBtn"
                                       >Submit</button>
                                    {{-- <button class="btn btn-danger"  href="{{route('ourproductlist-index')}}">Cancel</button> --}}
                                </div>
                            </form><!-- Vertical Form -->
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.submitourproductlistBtn').click(function(e) {
                //alert('jijed');
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    url: '{{ route('store-ourproductlist') }}',
                    data: formData,
