...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="margin-top: 20px">Add Services</h1>
      <span><h1 style="margin-top:-30px; margin-left:95%;"><a href="{{route('services-index')}}">Back</a></h1></span>
      {{-- <nav>
        <ol class="breadcrumb">
      ...
      @endif
          <div class="card">
            <div class="card-body p-3" >
              ...
              <!-- Vertical Form -->
              <form class="row g-3" action="{{route('store-services')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="col-12">
                ...
                <div class="card-action">
                  <button class="btn btn-success submitEditServicesBtn"
                      href="{{route('services-index')}}">Submit</button>
                  {{-- <button class="btn btn-danger"  href="{{route('services-index')}}">Cancel</button> --}}
              </div>
              </form><!-- Vertical Form -->
