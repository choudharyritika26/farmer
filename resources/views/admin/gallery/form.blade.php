...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="margin-top: 20px">Add Gallery</h1>
      <span><h1 style="margin-left: 95%; margin-top: -30px"><a href="{{route('gallery-index')}}">Back</a></h1></span>
      {{-- <nav>
        <ol class="breadcrumb">
            ...
            <div class="card-body">
              ...
              <form class="row g-3" action="{{route('store-gallery')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-action">
                  <button class="btn btn-success submitGalleryBtn"
                      href="{{route('gallery-index')}}">Submit</button>
                  {{-- <button class="btn btn-danger"  href="{{route('gallery-index')}}">Cancel</button> --}}
              </div>
              </form><!-- Vertical Form -->
  ...
  <script>
      $(document).ready(function() {
          ...
          $('.submitGalleryBtn').click(function(e) {
              //alert('jijed');
              e.preventDefault();
              ...
              $.ajax({
                  ...
                  url: '{{ route('store-gallery', isset($gallery) ? $gallery->id : null) }}',
                  data: formData,
