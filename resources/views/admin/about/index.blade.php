...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1 style="margin-top: 20px">About Tables</h1>

            <h1 style="margin-left: 95%; margin-top: -30px"><a href="{{ route('add-about') }}">Add </a></h1>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center">
                                                    ...
                                                    <form method="POST" action="{{ route('destroy-about', $item->id) }}"
