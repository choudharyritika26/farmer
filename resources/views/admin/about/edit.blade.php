...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            {{-- <button class="btn btn-dark" href="{{ route('about-index') }}">Submit</button> --}}
            <span>
                <h1 style="margin-top:-30px; margin-left:95%;"><a href="{{ route('about-index') }}">Back</a></h1>
            </span>
            {{-- <nav>
        <ol class="breadcrumb">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('update-about',$about->id) }}" method="post"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="col-12">
                                    <label for="heading" class="form-label">Heading</label>
                                    <input type="text" class="form-control" name="heading"
                                        value="{{ $about->heading }}"id="heading">
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <img src="{{ asset('storage/' . $about->image) }}" alt="" class="img-fluid mb-3"
                                        style="width: 200px;height:150px;">
                                    <input type="file" class="form-control" name="image" value="{{ $about->image }}"
                                        id="image">
                                </div>

                                <div class="card-action submitEditAboutBtn">
                                    <button class="btn btn-success" href="{{ route('about-index') }}">Submit</button>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.submitEditAboutBtn').click(function(e) {
                //alert('jijed');
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    url: '{{ route('update-about', $about->id) }}',
                    data: formData,
