                            ...
                            <form class="row g-3" action="{{ route('update-singleproduct',$singleproduct->id) }}" method="post"
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" name="heading"
                                        value="{{ $singleproduct->heading }}"id="heading">
                                </div>

                                <div class="form-group">
                                    <label for="comment">Description</label>
                                    <textarea class="form-control" id="comment" name="description" rows="3">{{ $singleproduct->description }} </textarea>
                                ...
                                <div class="col-12">
                                    ...
                                    <img src="{{ asset('storage/' . $singleproduct->image) }}" alt="" class="img-fluid mb-3"
